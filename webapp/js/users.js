...
//提交个人简历信息
function checkResumeInfo(form) {
    var name = form.name.value;
    if (name == "" || name == null) {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'姓名不能为空'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
    ...
    if (sex == "" || sex == null) {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'请选择性别，性别信息不能为空'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
    ...
    if (edubackground == "" || edubackground == null) {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'学历信息不能为空，请选择您的学历信息'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
    ...
    var edusystem = form.edusystem.value;
    if (edusystem == "" || edusystem == null) {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'学制信息不能为空，请填写学制信息，例如“4年制”或者“3年制”'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
    ...
    if (school == "" || school == null) {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'毕业院校信息不能为空，请填写您的毕业院校'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
    ...
    if (major == "" || major == null) {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'所学专业信息不能为空，请填写您的所学专业'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
    ...
    if (telephone == "" || telephone == null) {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'手机号码不能为空，请填写您的手机号码'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
        ...
        if (checkMPhone(telephone) == false) {
            $.msgbox({
                height: 120,
                width: 300,
    ...
    var graduationtime = form.graduationtime.value;
    if (graduationtime == "" || graduationtime == null) {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'毕业日期不能为空，请填写您的毕业日期'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
        ...
        if (IsDate(graduationtime)==false) {
            $.msgbox({
                height:120,
                width:300,
                content:{type:'alert', content:'毕业日期格式不正确，请按正确日期格式填写'},
                animation:0,       //禁止拖拽
                drag:false         //禁止动画
                //autoClose: 10     //自动关闭
            });
    ...
    var resumefilename = form.resumefilename.value;
    if (resumefilename == "" || resumefilename == null) {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'未上传您的个人简历，请上传您的个人简历'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
