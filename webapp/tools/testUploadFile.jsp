...
<body>
<form action="/Upload.do" method="post" enctype="multipart/form-data" target="upload_iframe" onsubmit="upload()">
    <p><input type="file" name="file" id="fUpload"></p>
    <!--p><input type="button" name="OK" value="test" onclick="getFilename();"></p-->
    <div id="bid" style="float: left;">
        <input type="submit" value="上传文件">
    </div>
    <div style="padding-left:100px;">
        <input type="button" id="closeid" value="关闭" onclick="javascript:window.close();" disabled>
    </div>
</form>
